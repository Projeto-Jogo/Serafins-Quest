...
string = "Voce se afasta do bebado e volta a procurar novas fonte de informaçao"
...
string = "Os segurancao da taverna vem a briga e separam voce antes que alguma coisa aconteça, entao voce volta a procurar informaçoes"
